...
/obj/machinery/public_nanite_chamber/attackby(obj/item/I, mob/user, params)
	if(!occupant && default_deconstruction_screwdriver(user, I))//sent icon_state is irrelevant...
...
/obj/machinery/public_nanite_chamber/mouse_drop_receive(mob/target, mob/user, params)
