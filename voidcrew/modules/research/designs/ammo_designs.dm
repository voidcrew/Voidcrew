 ...
 * the protolathe board ships in the same R&D kit as the destructive analyzer. They can
 * also be learned one at a time by reverse-engineering a real sample in a destructive
 * analyzer, see voidcrew/modules/research/edits/destructive_analyzer.dm.
 *
