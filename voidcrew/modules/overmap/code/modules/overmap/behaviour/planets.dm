/datum/overmap/planet
	...
	///The area type for the underground cave z-level. Planets with both this and
	///surface_area set build as a surface + cave pair; anything else is a flat encounter.
	var/area/cave_area
