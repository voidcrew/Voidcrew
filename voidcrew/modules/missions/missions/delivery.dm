...
/datum/mission/delivery/generate_mission_details()
	...
	var/static/list/delivery_targets = list(
		list("type" = /obj/item/stack/ore/iron, "name" = "iron ore", "amount" = 10, "value" = 800),
		list("type" = /obj/item/stack/ore/plasma, "name" = "plasma ore", "amount" = 5, "value" = 1200),
		list("type" = /obj/item/stack/ore/gold, "name" = "gold ore", "amount" = 3, "value" = 1500),
		list("type" = /obj/item/stack/ore/silver, "name" = "silver ore", "amount" = 5, "value" = 1000),
		list("type" = /obj/item/stack/ore/uranium, "name" = "uranium ore", "amount" = 3, "value" = 1800),
		list("type" = /obj/item/stack/ore/diamond, "name" = "diamonds", "amount" = 2, "value" = 2500),
		list("type" = /obj/item/stack/sheet/iron, "name" = "iron sheets", "amount" = 20, "value" = 600),
		list("type" = /obj/item/stack/sheet/glass, "name" = "glass sheets", "amount" = 20, "value" = 500),
		list("type" = /obj/item/stack/sheet/plasteel, "name" = "plasteel sheets", "amount" = 5, "value" = 2000),
	)
