...
/datum/mission/exploration/proc/check_position()
	...
	if(dist <= completion_range)
		visited = TRUE
		servant.ship_notify("Survey coordinates reached! Return to the mission board to collect your reward.", "MISSION UPDATE", SHIP_NOTIFY_NOTICE, 'voidcrew/sound/notify.ogg')
