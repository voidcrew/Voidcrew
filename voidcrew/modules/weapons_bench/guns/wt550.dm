...
/datum/techweb_node/weapon_part_wt550
	...
	unlocked_designs = list(/datum/design/gun_part_wt550)
...
/datum/techweb_node/weapon_ammo_wt550
	...
	prerequisite_nodes = list(/datum/techweb_node/weapon_part_wt550)
	unlocked_designs = list(/datum/design/ammo_wt550)
