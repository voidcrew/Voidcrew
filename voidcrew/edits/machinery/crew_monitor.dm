 ...
 * there is one.
 */
/proc/voidcrew_crew_sensor_cache_key(obj/docking_port/mobile/voidcrew/hull, scope_z)
	return hull ? "hull_[REF(hull)]" : "z_[scope_z]"
 ...
 * put them on a stranger's.
 */
/proc/voidcrew_crew_sensor_in_scope(mob/living/tracked, turf/pos, obj/docking_port/mobile/voidcrew/hull, scope_z)
	...
	return isnull(their_hull) || their_hull == hull
