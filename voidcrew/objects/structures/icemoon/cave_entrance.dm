	...
	switch(loot)
		...
		if(4)//hogwart's school of witchcraft and wizardry. Featuring incredible loot at incredibly low chances
			...
			if(prob(15))
				...
				new /mob/living/basic/wizard(loc)
			if(prob(25))
				new /obj/item/guardian_creator(loc)
				new /mob/living/basic/wizard(loc)
		...
		if(12)//miner's last moments
			...
			if(prob(45))
				new /mob/living/basic/mining/goliath(loc)
			if(prob(35))
			...
			new /mob/living/basic/mining/goliath(loc)
			new /mob/living/basic/mining/goliath(loc)
			new /mob/living/basic/mining/goliath/ancient(loc)
		...
		if(15)//fallout ss13
			...
			if(prob(50))
				...
				new /mob/living/basic/cockroach/glockroach(loc)
			if(prob(45))
				new /obj/item/stack/sheet/mineral/uranium/five(loc)
				new /mob/living/basic/cockroach/glockroach(loc)
			if(prob(35))
		...
		if(17)//the backroom freezer
			...
			if(prob(25))
				...
				new /mob/living/simple_animal/hostile/killertomato(loc)
			new /mob/living/basic/alien/maid(loc)
		...
		if(19)//xenobiologist's hubris
			...
			if(prob(25))
				...
				new /mob/living/basic/slime/random(loc)
			if(prob(25))
