...
/datum/mod_theme/loader
	...
	extended_desc = "This powered suit is an experimental spinoff of standard Engineering suits. \
		...
		sealing against vacuum while still offering exceptional strength and flexibility. The primary feature of \
...
/datum/mod_theme/infiltrator
	...
	inbuilt_modules = list(/obj/item/mod/module/infiltrator, /obj/item/mod/module/storage/belt, /obj/item/mod/module/hearing_protection, /obj/item/mod/module/night) // VOIDCREW EDIT: removes the demoralizer
	allowed_suit_storage = list(
		/obj/item/restraints/handcuffs,
		/obj/item/assembly/flash,
		/obj/item/melee/baton,
