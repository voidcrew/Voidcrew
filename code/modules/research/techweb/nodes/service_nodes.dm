/datum/techweb_node/office_equip
	...
	description = "Nanotrasen's finest in ergonomic office tech, ensuring station admin stays productive and compliant with corporate policies, because even in space, paperwork never stops." // VOIDCREW EDIT: em-dash swapped for a comma
