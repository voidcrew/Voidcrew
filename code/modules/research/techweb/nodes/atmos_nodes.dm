/datum/techweb_node/atmos
	...
	unlocked_designs = list(
		...
		/datum/design/rpd, // VOIDCREW EDIT: moved here from the tier-3 Fusion node; ships need pipe repair from roundstart and Fusion is hours away (BAL-6)
	)
...
/datum/techweb_node/fusion
	...
	unlocked_designs = list(
		...
		// VOIDCREW EDIT: /datum/design/rpd moved to the starting Atmospherics node (BAL-6)
