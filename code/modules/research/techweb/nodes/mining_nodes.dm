...
/datum/techweb_node/bitrunning
	...
	unlocked_designs = list(
		...
		/datum/design/board/quantum_server, // VOIDCREW EDIT: researchable server; upstream hand-places it
		/datum/design/board/bitrunning_order_console, // VOIDCREW EDIT: spends the points the loop pays out; upstream hand-places it
	)
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = TECHWEB_TIER_3_POINTS)
	announce_channels = list(RADIO_CHANNEL_SUPPLY)
