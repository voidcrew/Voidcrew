...
/obj/item/clothing/head/costume/ushanka
	...
	flags_1 = IS_PLAYER_COLORABLE_1
	// VOIDCREW: the ushanka gets real in-hand sprites instead of vanishing when held.
...
/obj/item/clothing/head/costume/ushanka/attack_self(mob/user)
	// VOIDCREW: only the worn/ground sprite has ear flap states; the in-hand sheet does not,
	// so inhand_icon_state is deliberately left alone here.
	if(earflaps)
		icon_state = upsprite
...
/obj/item/clothing/head/costume/ushanka/polar
	...
	inhand_icon_state = "ushanka_polar" // VOIDCREW
