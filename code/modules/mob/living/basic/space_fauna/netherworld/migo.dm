...
/mob/living/basic/migo/send_speech(message_raw, message_range, obj/source, bubble_type, list/spans, datum/language/message_language, list/message_mods, forced)
	. = ..()
	if(stat != CONSCIOUS)
		return
	make_migo_sound()
