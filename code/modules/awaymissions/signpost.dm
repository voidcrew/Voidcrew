/obj/structure/signpost
	...
	/// Kept for upstream subtypes; voidcrew signposts all teleport through interact() below.
	var/teleports = FALSE
	/// Text that will appear in the teleport prompt.
	var/question = "Travel back?"
	/// Optional list of z-levels that anywhere-roll signposts can send us to. Modify this on Initialize().
...
/obj/structure/signpost/void/get_destination_turf(mob/user)
