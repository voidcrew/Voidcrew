...
GLOBAL_LIST_INIT(plasteel_recipes, list ( \
	...
	new/datum/stack_recipe("blast door assembly", /obj/machinery/door/poddoor/preopen/deconstructed, 15, time = 8 SECONDS, crafting_flags = CRAFT_ONE_PER_TURF, category = CAT_DOORS), // VOID TEST EDIT
	null,
	new /datum/stack_recipe_list("airlock assemblies", list( \
