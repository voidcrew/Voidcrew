...
/turf/closed/mineral/proc/gets_drilled(mob/user, exp_multiplier = 0)
	...
	if(mineral_type && (mineral_amt > 0))
		mineral_amt = zone_scaled_ore_amount(mineral_amt) // VOIDCREW EDIT: deeper-zone planets yield more ore per wall (see voidcrew/turfs/closed/minerals.dm)
...
/turf/closed/mineral/random/snow/underground
	// VOIDCREW EDIT REMOVAL: upstream dropped the redundant `baseturfs` override here; the
	// fork's FROZEN-breathable baseturfs is now inherited from /turf/closed/mineral/random/snow
	// VOIDCREW EDIT ORIGINAL: baseturfs = /turf/open/misc/asteroid/snow/icemoon/breathable
	// abundant ore
	mineral_chance = 11
