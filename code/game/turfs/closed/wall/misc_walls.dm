...
/turf/closed/wall/r_wall/rust
	//SDMM supports colors, this is simply for easier mapping
	WHEN_MAP(color = COLOR_ORANGE_BROWN)
	// VOIDCREW EDIT: was "rusty_r_wall" - icons/turf/walls/reinforced_states.dmi only ships
	// rusty_wall-1..6, so the upstream value leaves rusted r_walls blank while deconstructing
