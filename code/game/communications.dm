...
GLOBAL_LIST_INIT(default_radio_channels, list(
	...
	RADIO_CHANNEL_WIDEBAND = FREQ_WIDEBAND, // VOIDCREW EDIT ADDITION
...
GLOBAL_LIST_INIT(reserved_radio_frequencies, list(
	...
	"[FREQ_WIDEBAND]" = RADIO_CHANNEL_WIDEBAND, // VOIDCREW EDIT ADDITION
...
GLOBAL_LIST_INIT(reserved_radio_colors, list(
	...
	RADIO_CHANNEL_WIDEBAND = RADIO_COLOR_WIDEBAND, // VOIDCREW EDIT ADDITION
